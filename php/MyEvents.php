...
.badge-widget{background:#fafafa;border:1px solid #e5e7eb;padding:.45rem .85rem;border-radius:.75rem}
.badge-name{font-size:.8rem;font-weight:600}
.badge-pts{font-size:.73rem;color:#6b7280}
...
<div class="nav-links">
<a href="home.php" class="nav-link"><span>الرئيسية</span></a>
<a href="MyEvents.php" class="nav-link active"><span>فعالياتي</span></a>
<a href="organized-events.php" class="nav-link"><span>فعالياتي المنظمة</span></a>
</div>
...
<input type="hidden" name="cancel_event_id" value="<?= (int)$event['event_id'] ?>">
<button class="btn btn-danger" type="submit">إلغاء التسجيل</button>
</form>
